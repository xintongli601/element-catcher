...
- Milestone 10: Current for private/session-state capture reliability. Slice 1 implementation is pending independent/manual acceptance. See `docs/MILESTONE_10_PRIVATE_SESSION_CAPTURE.md`.
